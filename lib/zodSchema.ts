...
export const courseSubject = ["MATHEMATICS", "SCIENCE", "SOCIAL SCIENCE", "ENGLISH"] as const;  

export const courseStatus = ["DRAFT", "PUBLISHED","ARCHIVED"] as const;

export const courseClass = ["9TH", "10TH", "11TH", "12TH"] as const;
...
export const courseSchema = z.object({
  ...
  subject: z.enum(courseSubject,{message:"Subject is required"}),
  class: z.enum(courseClass,{message:"Class is required"}),
