...
import { PublicCourse } from "@/app/data/course/get-all-courses";
...
export function PublicCourseCard({data}: iAppProps){
  const thumbnail = useConstruct(data.fileKey)
  return(
    <Card className="group relative py-0 gap-0">
      ...
      <CardContent className="p-4">
        <Link className="font-medium text-lg line-clamp-2 group-hover:text-primary transition-colors" href={`/courses/${data.slug}`} >{data.title}</Link>
