...
function Tabs({
  ...
  const [activeTab, setActiveTab] = React.useState<string>(props.defaultValue || (props.value as string) || "")
...
const TabsContext = React.createContext<{ activeTab: string; layoutId: string }>({ activeTab: "", layoutId: "" })
  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        ...
        "data-active:text-foreground dark:data-active:text-foreground z-10",
        className
      )}
      {...props}
    >
